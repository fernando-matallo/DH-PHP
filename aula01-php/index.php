...
<body>
    <section class="container">
        <article class="row">
            ...
            <!-- Criando o array para exibir em uma lista -->
            <?php
            ...
            <p><?php echo "O resultado da divisão $numero1 e $numero2 é $divisao"; ?> </p>
            <p><?php echo "O resto da divisão $numero1 e $numero2 é $resto"; ?> </p>
